    ...
    return (
        <div className="container">
            <section className="content">
                <div className="text">
                    <h1>
                        <div>ระบบแผนที่ออนไลน์</div>
                        <div><span className="naresuan-university">อุทยานแห่งชาติภูหินร่องกล้า </span></div>
                    </h1>
                    <p>
                        แผนที่ออนไลน์อุทยานแห่งชาติภูหินร่องกล้า เป็นโครงงานที่มีเป้าหมายในการสนับสนุนการท่องเที่ยวของอุทยานแห่งชาติภูหินร่องกล้า โดยเน้นการใช้เทคโนโลยีสารสนเทศเพื่อเพิ่มความสะดวกและประสิทธิภาพให้แก่ผู้ใช้บริการ
                    </p>
